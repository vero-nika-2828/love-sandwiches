...
def validate_data(values):
    """
    Inside the try, converts all string values into integrers.
...
def calculate_surplus_data(sales_row):
    ...
    -Negative surplus inidacates extra made when stock was sold out.
    """
    print("Calculating surplus numbers...\n")
...
def get_last_5_sales():
    """
    Collects collumns of data from sales worksheet,colletcting 
